    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-nav">
        <div class="navbar-container container-fluid">
            <div class="logo align-items-center">
                <a class="" href="a">
                    <h4 class="black align-middle">Bali Asri</h4>
                </a>
            </div>
      ...
      <div class="header-banner">
        <div class="container">
            <div class="text-banner">
                <h2 class=" poppins">Welcome to Bali Asri</h2>
                <p>Find your taste of fashion and build your style here</p>
                <button class="btn btn-discover">Discover now </button>
            </div>
